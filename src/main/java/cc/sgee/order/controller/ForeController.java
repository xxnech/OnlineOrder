...
public class ForeController {
    ...
    @RequestMapping("/foreNotice")
    public String forceNotice(Model model){
        List<Notice> noticeList = noticeService.list();
        model.addAttribute("notice",noticeList);
        return "forepage/foreNotice";
    }
    ...
    @RequestMapping("/updateOrderItemNumber")
    @ResponseBody
